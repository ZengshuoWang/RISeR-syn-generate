...
## Congratulations! The paper has been published! 
- The `main. py` contains all the code for generating RISeR-syn, and a more detailed description can be found in our paper.
- If the code is helpful to you, please make sure to cite our paper! Thank you!
- If you have any questions, please feel free to contact me via email `zengshuowang@mail.nankai.edu.cn`!
```
Wang Z, Zou H, Zhao X, Wang Y, Sun M. A Retinal Image Sequence Registration Method Based on Longitudinal 3D Fundoscopy Scene Modeling.
IEEE Trans Image Process. 2026;35:8064-8079. doi:10.1109/TIP.2026.3715100
```
